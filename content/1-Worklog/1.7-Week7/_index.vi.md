...
* Khởi động dự án Capstone LiveCap, tiến hành phân tích yêu cầu dự án và phác thảo thiết kế hệ thống.
...
| 6 | - **Dự án Capstone:** Khởi động LiveCap, phân tích yêu cầu thiết kế và phác thảo luồng dữ liệu (WebSocket, PCM audio) | 05/06/2026 | 05/06/2026 | <https://cloudjourney.awsstudygroup.com/> |
...
* Bắt đầu dự án LiveCap, xác định các yêu cầu cốt lõi và đề xuất luồng giao tiếp WebSocket cho hệ thống.
