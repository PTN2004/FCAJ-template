...
* Triển khai truyền tải luồng âm thanh PCM từ trình duyệt đến backend qua WebSocket và kết nối dịch vụ Amazon Transcribe Streaming.
...
| 6 | - **Dự án Capstone:** Phát triển AudioWorklet ghi âm PCM 16kHz trên browser và viết logic kết nối WebSocket đến Amazon Transcribe Streaming trên FastAPI | 12/06/2026 | 12/06/2026 | <https://cloudjourney.awsstudygroup.com/> |
...
* Xây dựng thành công đường truyền speech-to-text thời gian thực sử dụng AudioWorklet và kết nối Amazon Transcribe Streaming.
